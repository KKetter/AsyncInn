...
namespace AsyncInn.Controllers
{
    public class RoomAmenitiesController : Controller
    {
        ...
        public RoomAmenitiesController(AsyncInnDbContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public async Task<IActionResult> Edit(int id, [Bind("AmenitiesID,RoomID")] RoomAmenities roomAmenities)
        {
            ...
            ViewData["AmenitiesID"] = new SelectList(_context.Amenities, "ID", "Name", roomAmenities.RoomID);
            ViewData["RoomID"] = new SelectList(_context.Room, "ID", "ID", roomAmenities.RoomID);
            return View(roomAmenities);
        }
